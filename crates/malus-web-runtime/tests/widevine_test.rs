...
use malus_web_runtime::widevine::{
...
fn create_mock_elf(dir: &Path, filename: &str) -> PathBuf {
    ...
    hdr[4] = malus_web_runtime::widevine::EXPECTED_ELF_CLASS;
    hdr[5] = malus_web_runtime::widevine::EXPECTED_ELF_DATA;
    let machine_bytes = malus_web_runtime::widevine::EXPECTED_ELF_MACHINE.to_le_bytes();

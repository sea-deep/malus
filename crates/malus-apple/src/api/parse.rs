...
/// Parse Apple track (song) JSON into normalized TrackWire with `apple:track:{id}` MediaId.
...
/// Parse Apple album JSON into normalized AlbumWire with `apple:album:{id}` MediaId.
...
/// Parse Apple artist JSON into normalized ArtistWire with `apple:artist:{id}` MediaId.
...
/// Parse Apple playlist JSON into normalized PlaylistWire with `apple:playlist:{id}` MediaId.
